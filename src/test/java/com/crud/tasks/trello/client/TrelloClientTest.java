...
class TrelloClientTest {
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        when(restTemplate.postForObject(
                ...
                ArgumentMatchers.eq(trelloCardDto),
                ArgumentMatchers.eq(CreatedTrelloCard.class)
        ...
        // Then
        assertNotNull(newCard, "The newCard object is null, check your stubbing or method logic");
